...
public class Player1C2 extends Entity{
    ...
    public Player1C2(Chapter2 gp, KeyHandlers keyH, CrimsonP2 player2_2){
        this.gp = gp;
        this.keyH = keyH;
...
//        getHealth();
    ...
    public void update() {
        ...
        if(!isTakeHit) {
            ...
            if (keyH.jPressed) {
                isUsingSkillJ = true;
                animationFrame = 0;
                attackBody.setX(direction.equals("left") ? x - 50 : x + 50);
                attackBody.setY(y);
                skillCounter = 0;
            }
    ...
    public void draw(GraphicsContext gc) {
        ...
        // Vẽ hình ảnh cho skill nhảy
            ...
            if (direction.equals("left")){
                switch (animationFrame){
                    case 0: image = L_takeHit1; break;
                }
            }
            else {
                switch (animationFrame){
                    case 0: image = R_takeHit1; break;
                }
            }
